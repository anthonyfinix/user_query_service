import joi from "joi";
const joi_primary_number = joi.number().required();
const joi_secondary_number = joi.number();
const joi_email = joi.string().email().required();
const joi_city = joi.string().required();
const joi_address = joi.string();
const joi_state = joi.string().required();
const joi_pincode = joi.number().required();
